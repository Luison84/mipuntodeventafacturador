                                        ...
                                        <div class="card card-gray shadow">
                                            ...
                                            <div class="card-body py-2">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-floating mb-2">
                                                            <input type="text" id="correlativo" class="form-control" name="correlativo" readonly required>
                                            ...
                                            <div class="card-body py-2">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <div class="form-floating mb-2">
                                                            <select class="form-select select2" id="tipo_documento" name="tipo_documento" aria-label="Floating label select example" required readonly>
                                                            </select>
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <div class="form-floating mb-2" style="position: relative;">
                                                            ...
                                                            <i class="fas fa-search fs-5 text-primary" id="btnConsultarDni" style="cursor: pointer; position: absolute; top: 50%; right:25px; transform: translateX(-50%) translateY(-50%);"></i>
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <div class="form-floating mb-2">
                                                            <input type="text" id="nombre_cliente_razon_social" class="form-control" name="nombre_cliente_razon_social" required>
                                            ...
                                            <div class="card-body py-2">
                                                ...
                                                <div class="row fw-bold">
                                                    ...
                                                    <div class="col-12 text-center mt-3">
                                                        <a class="btn btn-outline-success w-100 fw-bold" id="btnGuardarComprobante">GENERAR VENTA</a>
                                                    </div>
...
<script>
    ...
    function CargarSelects() {
        ...
        CargarSelect('01', $("#tipo_comprobante"), "--Seleccione Tipo Comprobante--", "ajax/series.ajax.php", 'obtener_tipo_comprobante');
        CargarSelect(null, $("#serie"), "--Seleccione Serie--", "ajax/ventas.ajax.php", 'obtener_serie_comprobante', $('#tipo_comprobante').val());
        fnc_ObtenerCorrelativo($("#serie").val())
        CargarSelect('PEN', $("#moneda"), "--Seleccione Moneda--", "ajax/ventas.ajax.php", 'obtener_moneda');
        CargarSelect('6', $("#tipo_documento"), "--Seleccione Tipo Documento--", "ajax/ventas.ajax.php", 'obtener_tipo_documento');
        ...
        $("#tbl_facturas").DataTable({
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    orderable: false,
                    createdCell: function(td, cellData, rowData, row, col) {
                        $(td).html("<span class='btnImprimirFactura text-success px-1' style='cursor:pointer;' data-bs-toggle='tooltip' data-bs-placement='top' title='Imprimir Boleta (ticket)'>" +
