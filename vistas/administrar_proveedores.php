                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3 mb-2">
                                        ...
                                        <!-- <div class="form-floating mb-2" style="position: relative;">
                                            <input type="text" id="nro_documento" class="form-control" name="nro_documento" onchange="validateJS(event, 'ruc')" required>
                                    ...
                                    <div class="col-12 mt-2">
                                        ...
                                        <!-- <div class="float-right">
                                            ...
                                            <a class="btn btn-sm btn-danger  fw-bold w-75" id="btnCancelarProveedor" style="position: relative;">
                                                <span class="text-button">CANCELAR</span>
                                                <span class="btn fw-bold icon-btn-danger d-flex align-items-center">
                                                    <i class="fas fa-times fs-5 text-white m-0 p-0"></i>
                                                </span>
                                            ...
                                            <a class="btn btn-sm btn-success  fw-bold w-75" id="btnRegistrarProveedor" style="position: relative;">
                                                <span class="text-button">GUARDAR</span>
                                                <span class="btn fw-bold icon-btn-success d-flex align-items-center">
                                                    <i class="fas fa-save fs-5 text-white m-0 p-0"></i>
                                                </span>
