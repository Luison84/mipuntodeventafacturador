                ...
                <div class="card card-gray shadow">
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row fw-bold">
                            ...
                            <div class="col-md-5 text-right">
                                S./ <span class="" id="boleta_ope_gravadas">0.00</span>
                            </div>
                            ...
                            <div class="col-md-5 text-right">
                                S./ <span class="" id="boleta_ope_inafectas">0.00</span>
                            </div>
                            ...
                            <div class="col-md-5 text-right">
                                S./ <span class="" id="boleta_ope_exoneradas">0.00</span>
                            </div>
...
<script>
    ...
    function recalcularTotales() {
        ...
        $("#boleta_ope_gravadas").html(parseFloat(subtotal).toFixed(2));
        ...
        if (count > 0) {
            ...
            if ($("#iptEfectivoRecibido").val() > 0 && $("#iptEfectivoRecibido").val() != "") {
                ...
                table.rows().eq(0).each(function(index) {
                    ...
                    arr[index] = data['codigo_producto'] + "," + parseFloat($.parseHTML(data['cantidad'])[0]['value']);
                ...
                $.ajax({
                    ...
                    success: function(respuesta) {
                        ...
                        window.open('http://localhost/market-pos-youtube/vistas/generar_ticket.php?nro_boleta=' + nro_boleta);
