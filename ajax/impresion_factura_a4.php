    ...
    <table style="width: 100%;margin-top: 20px;">
        ...
        <body>
            <tr style="border-width: 1px;border-color: black; ">
                <span style="font-size: 13px;padding: 10px;">CLIENTE</span> <br>
                <span style="font-size: 13px;padding: 10px;">RUC</span> <br>
                <span style="font-size: 13px;padding: 10px;">DIRECCIÓN</span> <br>
                <span style="font-size: 13px;padding: 10px;">FECHA DE EMISIÓN</span>
            </tr>
