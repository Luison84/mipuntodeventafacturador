...
if (isset($_GET["accion"])) {
    ...
    switch ($_GET["accion"]) {
        ...
        case 'generar_ticket':
            ...
            //DATOS DEL CLIENTE
            $pdf->Cell(10, 4, strtoupper("Cliente: "), 0, 0, 'L');
            $pdf->Cell(60, 4, strtoupper("Luis Angel Lozano Arica"), 0, 0, 'L');

            $pdf->Ln(5);
            $pdf->Cell(10, 4, strtoupper("Nro. Doc: "), 0, 0, 'L');
            $pdf->Cell(60, 4, strtoupper("45257895"), 0, 0, 'L');
            ...
            $pdf->MultiCell(70, 4, utf8_decode("Representación impresa de la Boleta de Venta Electrónica, esta puede ser consultada en: www.tutorialesphperu.com"), 0, 0, 'L');
